...
function complete_option_defaults() {
	$defaults = array(
		...
		'totop_id' => '1',
		'footer_text_id' => __('&copy; Copyright 2019. SKT Actor Lite. All Rights Reserved. Designed by SKT Themes', 'complete'),
        ...
        'slide_title1' => '<small>Jennifer</small>Pepin',
        'slide_desc1' => 'ACTOR &nbsp;|&nbsp; MODEL',
        'slide_link1' => '#',
        'slide_btn1' => 'Contact Me',
        
        'slide_image2' => ''.get_template_directory_uri().'/images/slides/slider2.jpg',
        'slide_title2' => '<small>Natalya</small>James',
        'slide_desc2' => 'ACTOR &nbsp;|&nbsp; MODEL',
        'slide_link2' => '#',
        'slide_btn2' => 'Contact Me',
        
        'slide_image3' => ''.get_template_directory_uri().'/images/slides/slider3.jpg',
        'slide_title3' => '<small>Matilda</small>Morgan',
        'slide_desc3' => 'ACTOR &nbsp;|&nbsp; MODEL',
        'slide_link3' => '#',
        'slide_btn3' => 'Contact Me',
		...
		'mobbgtop_color_id' => '#00d1ba',
		'mobmenutxt_color_id' => '#ffffff',
		'mobmenutxt_active_color_id' => '#00d1ba',
		
		'mobtoggle_color_id' => '#00d1ba',
		...
		'sldtitle_font_id' => array('font-family' => 'Playfair Display', 'font-size' => '110px'),
		'slddesc_font_id' => array('font-family' => 'Assistant', 'font-size' => '25px'),
		...
		'sldbtn_color_id' => '#00d1ba',
		'sldbtn_hvtextcolor_id' => '#ffffff',
		'sldbtn_hvcolor_id' => '#282828',
		
		'slide_pager_color_id' => '#00d1ba',	
		'slide_active_pager_color_id' => '#00d1ba',
		'slider_wave_color' => '#00d1ba',
			
		'global_link_color_id' => '#00d1ba',
		'global_link_hvcolor_id' => '#685031',		
		
		'global_h1_color_id' => '#282828',
		'global_h1_hvcolor_id' => '#00d1ba',	
		'global_h2_color_id' => '#282828',
		'global_h2_hvcolor_id' => '#00d1ba',
		'global_h3_color_id' => '#282828',
		'global_h3_hvcolor_id' => '#00d1ba',
		'global_h4_color_id' => '#282828',
		'global_h4_hvcolor_id' => '#00d1ba',
		'global_h5_color_id' => '#282828',
		'global_h5_hvcolor_id' => '#00d1ba',
		'global_h6_color_id' => '#282828',
		'global_h6_hvcolor_id' => '#00d1ba',	
		
		'post_meta_color_id' => '#282828',
		'team_box_color_id' => '#f7f7f7',
		
		'social_text_color_id' => '#a6a6a6',
		...
		'testimonial_activepager_color_id' => '#00d1ba',
		...
		'perfect_hover_border_color' => '#00d1ba',
		...
		'footer_title_border_color' => '#00d1ba',
		...
		'featured_block_button_bg' => '#00d1ba',
		'featured_block_hover_button_bg' => '#393939',
		
		//Footer Column 1
		'foot_cols1_title' => __('SKT Actor Lite', 'complete'),
...
[/social_area]',
		...
		//Footer Column 3
		'foot_cols3_title' => __('NEW RELEASE', 'complete'),
