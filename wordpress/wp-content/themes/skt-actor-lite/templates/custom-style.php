<?php 
/**
 * The Custom Style for SKT Actor Lite
 *
...
/*-----------------------------COLORS------------------------------------*/
		...
		#topmenu ul li.appointment-btn a:hover{background-color: <?php echo $complete['menutxt_color_id'] ?>; color: <?php echo $complete['menutxt_color_active'] ?> !important;}
